...
INSERT INTO Messages VALUES (CURRENT_TIMESTAMP , 'Henrique' , 'Dennis', 'This shit actually works');



INSERT INTO Messages VALUES (CURRENT_TIMESTAMP , '1' , '2', 'test noise');
Select * from messages ORDER BY time DESC;



INSERT INTO Messages VALUES (CURRENT_TIMESTAMP , 'Dennis' , 'Henrique', 'Im imaginary Dennis, Henrique has fake conversations with me.');